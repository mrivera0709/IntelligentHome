...
<header>
    <div id="app">
        <nav class="black">
            <div className="row">
                <div class="nav-wrapper container noSidePadding">
                    <a href="{{ url('/home') }}" class="brand-logo font26 white-text light" style="text-decoration : none"> SMART TECH <span class="textGradient1 font36">find</span>ER
                    </a>
                    <a href="#" data-activates="mobile-demo" class="button-collapse" style="text-decoration : none"><i class="material-icons">menu</i>
                    </a>
